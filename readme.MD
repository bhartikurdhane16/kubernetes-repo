...
http://<pod_ip>:<mapped_nodeport>    # used combination of nodeport & pod ip to get access of application over external network
OR curl <pod_ip>:<mapped_node_port>    #access with combinate of pid ip & node port
