...
## how to create multiple container in pod using commands?
## multiple container in pod disadvantages in auto scalling?
## side car container with production applicationn& proxy container?
