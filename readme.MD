...
kubectl get svc -n <namespace_name>   # listout services at pod, 
kubectl get service            # listout the service
OR kubectl get svc             # we can also use short form of service it get when run #cubectl api-resources
