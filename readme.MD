...
http://<pod_ipminikube>:<mapped_nodeport>    # used combination of nodeport & pod ip to get access of application over external network
OR curl <pod_ip>:<mapped_nodeport>    #access with combinate of pid ip & node port
